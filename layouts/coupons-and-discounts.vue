...
<template>
  <main class="min-h-screen">
    ...
    <div class="flex justify-center bg-cover w-full h-96" :style="{'background-image': `url(${require('@/assets/img/coupons-and-discounts-header.jpg')})`}">
      <div class="flex flex-col space-y-12 py-10 px-16">
        <Nav />
          <div class="flex justify-center items-center bg-black/50 max-w-md max-h-36 px-2 py-4">
