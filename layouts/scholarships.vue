...
<template>
  <main class="min-h-screen bg-main-gold">
    ...
    <div class="flex justify-center bg-center bg-no-repeat w-full lg:bg-cover lg:h-550" :style="{'background-image': `url(${require('@/assets/img/scholarships-header.jpg')})`}">
